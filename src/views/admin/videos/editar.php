...
<head>
    ...
    <title>Editar Video - Filá Mariscales</title>
...
<body>
                                    ...
                                    <div class="card bg-light">
                                        <div class="card-body">
                                            ...
                                            <div id="videoPreview" class="text-center py-3">
                                                <?php 
                                                $videoThumbnail = $formData['url_thumbnail'] ?? '';
                                                $videoTipo = $formData['tipo'] ?? 'youtube';
                                                $videoUrl = $formData['url_video'] ?? '';
                                                
                                                if ($videoTipo === 'youtube' && $videoUrl) {
                                                    $videoModel = new Video();
                                                    $youtubeId = $videoModel->extractYouTubeId($videoUrl);
                                                    if ($youtubeId) {
                                                        $thumbnail = $videoThumbnail ?: 'https://img.youtube.com/vi/' . $youtubeId . '/maxresdefault.jpg';
                                                        echo '<img src="' . htmlspecialchars($thumbnail) . '" alt="Preview" class="img-fluid rounded mb-2" style="max-height: 200px;">';
                                                    }
                                                } else {
                                                    echo '<i class="bi bi-play-circle text-muted" style="font-size: 3rem;"></i><p class="text-muted small mt-2">Vista previa del video</p>';
                                                }
                                                ?>
                                            </div>
                                        </div>
    ...
    <script>
        // Vista previa de video (mismo código que crear.php)
